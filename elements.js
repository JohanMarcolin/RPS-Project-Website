...
export let splitRoundResultPlayer = document.querySelector("#split-result-player");
export let splitRoundResultComputer = document.querySelector("#split-result-computer");
  //PLAYER CHOICES
...
export let finalComparedScore = document.querySelector("#final-compared-score-display");
